      ...
      child: Column(
        ...
        children: [
          ...
          _buildFeatureItem(
            ...
            s.featureDiscoveryTitle,
            s.featureDiscoveryDesc,
          ),
          const SizedBox(height: 12),
          _buildFeatureItem(
          ...
          _buildFeatureItem(
            ...
            s.featureMonitorTitle,
            s.featureMonitorDesc,
          ),
          const SizedBox(height: 12),
          _buildFeatureItem(
            Icons.picture_as_pdf_rounded,
            s.featureExportTitle,
            s.featureExportDesc,
          ),
          const SizedBox(height: 12),
          _buildFeatureItem(
    ...
    return GlassmorphismCard(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDetailRow('Auth', 'local_auth'),
          _buildDetailRow('Monitoring', 'workmanager + notifications'),
          _buildDetailRow('Reports', 'pdf + printing'),
          _buildDetailRow(s.httpClientLabel, 'http + DNS-over-HTTPS'),
        ],
      ),
    );
  }
